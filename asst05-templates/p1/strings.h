...
/**
 * Returns a new null byte terminated string that is the result of appending
 * string s2 to s1. The caller is responsible to free the returned string.
 ...
 * Iterating over the array of substrings and putting the delimiter in between
 * two substrings results in the original string toSplit. The caller is
 * responsible to free the returned two dimensional array. Returns NULL on any
 * error.
 */
